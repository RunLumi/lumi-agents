...
Status: **Backend catalog and structured selection implemented; Chrome/computer adapters partial**
Date: 2026-09-21
...
| chrome | setup_required or ready | explicit selected-window attach; read/navigate only in approved origins |
